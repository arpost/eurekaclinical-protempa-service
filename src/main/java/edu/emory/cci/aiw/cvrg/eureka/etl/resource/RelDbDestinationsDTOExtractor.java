 ...
 * @author Andrew Post
 */
class RelDbDestinationsDTOExtractor extends DestinationsDTOExtractor<EtlRelDbDestination, RelDbDestinationEntity> {

    RelDbDestinationsDTOExtractor(AuthorizedUserEntity user, EtlGroupDao inGroupDao) {
        super(user, inGroupDao);
    }

    @Override
    EtlRelDbDestination extractDTO(Perm perm,
            RelDbDestinationEntity destinationEntity) {
        EtlRelDbDestination dest = new EtlRelDbDestination();
        ...
        List<RelDbDestinationTableColumnEntity> tableColumnEntities = destinationEntity.getTableColumns();
        for (RelDbDestinationTableColumnEntity entity : tableColumnEntities) {
