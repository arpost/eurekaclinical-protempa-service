 ...
 */
@Entity
@Table(name = "reldb_dest_tablecolumns")
public class RelDbDestinationTableColumnEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "reldbdestinations_id", nullable = false)
    private RelDbDestinationEntity destination;
    ...
    public void setDestination(RelDbDestinationEntity inDestination) {
    ...
    public RelDbDestinationEntity getDestination() {
